  ...
  try {
    ...
    schools.forEach(s => {
      ...
      tr.innerHTML = `
        ...
        <td><input type="text" class="form-input" id="school-code-${s.id}" value="${s.code}" style="padding: 4px; font-size: 0.85em; width: 100px; background: #f1f5f9; border:1px solid var(--border-color); color:var(--text-color); border-radius: 4px;"></td>
        <td><input type="text" class="form-input" id="admin-username-${s.id}" value="${s.admin_username || ''}" style="padding: 4px; font-size: 0.85em; width: 140px; background: #f1f5f9; border:1px solid var(--border-color); color:var(--text-color); border-radius: 4px;"></td>
        <td><input type="text" class="form-input" id="admin-password-${s.id}" value="${s.admin_password || ''}" style="padding: 4px; font-size: 0.85em; width: 100px; background: #f1f5f9; border:1px solid var(--border-color); color:var(--text-color); border-radius: 4px;"></td>
